...
echo "time to start the app. It automatically checks GitHub for updates on every launch and"
echo "pulls down any future changes on its own - no need to run this script again."
echo ""
